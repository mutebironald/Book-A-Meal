...
class TestUser(unittest.TestCase):
   ...
   #def test_signup_with_invalid_email(self):
        ...
        # }
        # response = self.client.post('/api/v1/auth/signup', content_type = 'application/json', data=json.dumps(user))
         #self.assertEqual(b"error: Invalid email.", response.data)
    ...
    #def test_signup_with_password_field_empty(self):
        ...
        #user = {
            ...
            #"password":""
        #}
        #response = self.client.post('/api/v1/auth/signup', content_type = 'multipart/form-data', data=json.dumps(user))
